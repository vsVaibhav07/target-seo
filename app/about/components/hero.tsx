      ...
      <div className="container mx-auto px-6 relative z-10 pt-20">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative py-4 text-center flex flex-col gap-0">
            ...
            <AnimatedHeading
              text="SEARCH"
              className="text-6xl md:text-9xl lg:text-[10rem] text-center  leading-[0.9] uppercase italic font-serif text-accent "
            />
          </div>
          ...
          >
            <p className="text-slate-400 text-lg md:text-xl font-light leading-relaxed text-center md:text-left md:w-2/3">
              We dismantle digital barriers to turn organic potential into{" "}
              <span className="text-white font-medium border-b border-accent/30">
                measurable market equity.
              </span>
            </p>

            <div className="flex items-center gap-8 md:w-1/3">
              <div className="text-left group cursor-default">
                <span className="block text-5xl font-black text-white group-hover:text-accent transition-colors duration-500">
                  16+
                </span>
                <span className="text-[10px] uppercase text-accent tracking-[0.2em] font-bold whitespace-nowrap">
                  Years of Experience
                </span>
              </div>
            </div>
