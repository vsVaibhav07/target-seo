...
export default function CTASection() {
  ...
  return (
    <section className="py-4 pb-20 relative flex flex-col items-center justify-center text-center px-6 overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center w-full mb-10">
        {/* LET'S SCALE - Size optimized to avoid cutting */}
         ...
         <SectionTitle className='  bg-[radial-gradient(circle_at_30%_30%,rgba(249,115,22,0.1),transparent_50%)]  ' text="LET'S SCALE" />
