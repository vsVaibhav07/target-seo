              ...
              {titleWords.map((word, i) => (
                <div key={i} className="overflow-visible py-2">
                  <m.span
                    ...
                    className={`font-(family-name:--font-dancing) block whitespace-nowrap text-7xl sm:text-8xl md:text-9xl font-bold leading-tight ${word === 'Serve' ? 'text-orange-500' : 'text-slate-900'}`}
                  >
                    {word}
                  </m.span>
                </div>
