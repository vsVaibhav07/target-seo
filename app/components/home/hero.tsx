...
export default function Hero5() {
  ...
  return (
    <section ref={containerRef} className="relative pt-36 lg:pt-44 min-h-screen bg-[#020617] flex items-center justify-center overflow-hidden py-20">
      <MagicCursor />
        ...
        <div className="relative z-10 w-full max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center">
          ...
          <div className="space-y-10">
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-semibold text-white tracking-tighter leading-[1.1] md:leading-[1] uppercase">
